...
<html>
<head>
<title>White Box Cleric Generator</title>
		...
		<form action="" id ="clericForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Alignment:</span>	
			  <select id="alignment" name="theAlignment" class="alignmentBox">			
               ...
               <p><span class="footnote2">&#42;Neutral Clerics are only allowed at the Referee's discretion.</span></p>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#clericForm").attr('action', "character/wb_cleric.php");
